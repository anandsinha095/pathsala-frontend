(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        _createClass(StudentProfileComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.apiCall.getRequestHeader("student/studentInfo/" + id, this.localData.getlocalData()['token']).subscribe(function (res) {
              _this7.student = res['data'];

              _this7.apiCall.getRequestHeader("classes/classList", _this7.localData.getlocalData()['token']).subscribe(function (res) {
                _this7.classes = res['data'];

                _this7.classes.forEach(function (ele) {
                  if (ele._id === _this7.student.classId) _this7["class"] = ele.name;
                });
              });
            });
          }
      ...
      var LoginService = /*#__PURE__*/function () {
        ...
        _createClass(LoginService, [{
          ...
          value: function signInApiCall(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this9.apiCall.postRequest(data, "user/login").subscribe(function (res) {
                if (res['data'].result['emailVerified'] && res['data'].result['status']) {
                  _this9.setLocalStoreage.setLocalData(res);

                  _this9.toastr.success("Welcome to Golden Era English School", "login successfully");

                  return resolve(_this9.router.navigate(['/home/']));
                }
              }, function (error) {
                if (error.status) return reject(error.error.message);
              });
      ...
      var RegisterService = /*#__PURE__*/function () {
        ...
        _createClass(RegisterService, [{
          ...
          value: function signup(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this10.apiCall.postRequest(data, "user/signUp").subscribe(function (res) {
                resolve(res);
              }, function (error) {
    ...
    function wZQN(module, __webpack_exports__, __webpack_require__) {
      ...
      var _service_commoncall_commoncall_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../../../service/commoncall/commoncall.service */
      "3NPm");
      /* harmony import */
      ...
      var EditClassComponent = /*#__PURE__*/function () {
        function EditClassComponent(router, route, formBuilder, toastr, apiCall, localData) {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](EditClassComponent, [{
          ...
          return [{
            ...
            type: _service_commoncall_commoncall_service__WEBPACK_IMPORTED_MODULE_5__["CommoncallService"]
          }, {
            type: _service_commonservice_common_service__WEBPACK_IMPORTED_MODULE_6__["CommonService"]
          }];
        }, null);
