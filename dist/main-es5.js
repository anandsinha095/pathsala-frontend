      ...
      var LoginService = /*#__PURE__*/function () {
        ...
        _createClass(LoginService, [{
          ...
          value: function signInApiCall(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this8.apiCall.postRequest(data, "user/login").subscribe(function (res) {
                if (res['data'].result['emailVerified'] && res['data'].result['status']) {
                  _this8.setLocalStoreage.setLocalData(res);

                  _this8.toastr.success("Welcome to Golden Era English School", "login successfully");

                  return resolve(_this8.router.navigate(['/home/']));
                }
              }, function (error) {
                if (error.status) return reject(error.error.message);
              });
      ...
      var RegisterService = /*#__PURE__*/function () {
        ...
        _createClass(RegisterService, [{
          ...
          value: function signup(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this9.apiCall.postRequest(data, "user/signUp").subscribe(function (res) {
                resolve(res);
              }, function (error) {
                ...
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    ...
                    case 6:
                      ...
                      this.toastr.error(_context4.t0, 'Opps!');
                      this.ngOnInit();
