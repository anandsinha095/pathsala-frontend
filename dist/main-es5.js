    ...
    function nxS(module, __webpack_exports__, __webpack_require__) {
      ...
      function StudentsComponent_tr_46_span_17_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function StudentsComponent_tr_46_span_17_Template_span_click_0_listener() {
      ...
      function StudentsComponent_tr_46_span_18_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function StudentsComponent_tr_46_span_18_Template_span_click_0_listener() {
      ...
      var LoginService = /*#__PURE__*/function () {
        ...
        _createClass(LoginService, [{
          ...
          value: function signInApiCall(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this7.apiCall.postRequest(data, "user/login").subscribe(function (res) {
                if (res['data'].result['emailVerified'] && res['data'].result['status']) {
                  _this7.setLocalStoreage.setLocalData(res);

                  _this7.toastr.success("Welcome to Golden Era English School", "login successfully");

                  return resolve(_this7.router.navigate(['/home/']));
                }
              }, function (error) {
                if (error.status) return reject(error.error.message);
              });
      ...
      var RegisterService = /*#__PURE__*/function () {
        ...
        _createClass(RegisterService, [{
          ...
          value: function signup(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this8.apiCall.postRequest(data, "user/signUp").subscribe(function (res) {
                resolve(res);
              }, function (error) {
